...
const IndexPage = ({ data }) => {
  ...
  const currentPage = 1
  const postsPerPage = 4 // see limit in graphql query below
  ...
  return (
    <Layout>
      <SEO title="Home" image="../images/aelhirach-small.jpg" keywords={[`gatsby`, `javascript`, `react`, `web development`, `blog`, `graphql`]} />
